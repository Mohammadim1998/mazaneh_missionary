    ...
    return (
        <div className="w-full border-[1px] border-[#E0DFDC] rounded-lg">
            ...
            <div className="shrink-0 w-full h-11 flex justify-center items-center border-t-[1px] border-dashed gap-x-[6px] ">
                <div className="w-4 h-4"><img src="/images/svg/certification/get.svg" alt="" className="" /></div>
                <span className="text-[#008A00] font-semibold text-sm leading-5">دریافت گواهی</span>
            </div>
        </div>
    );
}

export default SuccessCertification;