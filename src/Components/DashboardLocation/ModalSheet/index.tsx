        ...
        <div className={`z-30 fixed w-full ${openModalSheet ? "bottom-0 h-auto transition-all duration-1000" : "bottom-[-475px] transition-all duration-1000"} w-full pt-[3px] transition-all duration-700`}>
            <div className="w-full bg-white rounded-lg">
                ...
                <div className="py-4 px-[13px]">
                    <div className="w-full flex flex-col border-b-[#0000001A] border-b-[1px] pb-4">
                        ...
                        <div className="w-[103px] h-[27px] bg-[#F0F0F0] rounded-3xl flex items-center justify-center gap-x-2">
                            <Link href={`/mosquePage/${dataMap?.id}`}>
                ...
                <div className="w-full px-4 flex items-center pt-4 overflow-x-scroll sliderContainer1 pb-6">
                    ...
                    {/* <div className={`w-[143px] h-[31px] bg-white border-[#2B39A1] border-[1px] flex justify-center items-center gap-x-2 rounded-lg`}>
                        <div className="w-[10px] h-[10px]"><img src="/images/svg/map/plusBlue.svg" alt="" className="w-full h-full" /></div>
                        <span className="text-[#2B39A1] font-bold text-xs leading-5">ثبت فعالیت تبلیغی</span>
                    </div>

                    <div className="w-[143px] h-[31px] bg-white border-[#2B39A1] border-[1px] flex justify-center items-center gap-x-2 rounded-lg">
                        <div className="w-[10px] h-[10px]"><img src="/images/svg/map/plusBlue.svg" alt="" className="w-full h-full" /></div>
                        <span className="text-[#2B39A1] font-bold text-xs leading-5">ثبت سوابق تبلیغی</span>
                    </div>

                    <div className="w-[143px] h-[31px] bg-white border-[#2B39A1] border-[1px] flex justify-center items-center gap-x-2 rounded-lg">
                        <div className="w-[10px] h-[10px]"><img src="/images/svg/map/plusBlue.svg" alt="" className="w-full h-full" /></div>
                        <span className="text-[#2B39A1] font-bold text-xs leading-5">ثبت ظرفیت تبلیغی</span>
                    </div> */}
                    <Link href={"/registerReport"} className="w-full h-[42px] bg-[#5461CA] cursor-pointer flex justify-center items-center gap-x-2 rounded-lg">
