...
const SettingModal = ({ modalCloseHandler, openSettingModal }) => {
    ...
    return (
        <div className={`z-40 fixed ${openSettingModal ? "bottom-0" : "bottom-[-375px]"} left-0 right-0 px-6 py-8 bg-white rounded-t-[14px] shadow-[0px_-3px_8px_0px_#0000000D] transition-all duration-500`}>
            <div
