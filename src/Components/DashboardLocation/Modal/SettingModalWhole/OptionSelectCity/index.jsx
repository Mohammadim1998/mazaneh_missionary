...
const OptionSelectCity = ({ setCityInput, setOpenCityModal }) => {
    ...
    const cities = [
        { id: 1, name: "قم", arrange: "arr1", arrName: "arr" },
        { id: 2, name: "تهران", arrange: "arr2", arrName: "arr" },
        { id: 3, name: "اصفهان", arrange: "arr3", arrName: "arr" },
        { id: 4, name: "شیراز", arrange: "arr4", arrName: "arr" },
        { id: 5, name: "بندرعباس", arrange: "arr5", arrName: "arr" },
        { id: 6, name: "تبریز", arrange: "arr6", arrName: "arr" },
        { id: 7, name: "کیش", arrange: "arr7", arrName: "arr" },
        { id: 8, name: "مشهد", arrange: "arr8", arrName: "arr" },
    ];
    // useEffect(() => {
                    ...
                    {cities.map((city, index) => (
                        ...
                        >
                            <label htmlFor={city.arrange}
                                ...
                                <input type="radio" name={city.arrName} id={city.arrange} className="cityRadioButton" />
                                {city.name}
                            </label>
                        </label>
                    ))}
