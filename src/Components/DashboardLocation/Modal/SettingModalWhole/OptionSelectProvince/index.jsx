...
const OptionSelectProvince = ({ setProvince, setOpenProvinceModal }) => {
    ...
    const provinces = [
        { id: 1, name: "قم", arrange: "arrr1", arrName: "arr" },
        { id: 2, name: "تهران", arrange: "arrr2", arrName: "arr" },
        { id: 3, name: "اصفهان", arrange: "arrr3", arrName: "arr" },
        { id: 4, name: "شیراز", arrange: "arrr4", arrName: "arr" },
        { id: 5, name: "بندرعباس", arrange: "arrr5", arrName: "arr" },
        { id: 6, name: "تبریز", arrange: "arrr6", arrName: "arr" },
        { id: 7, name: "کیش", arrange: "arrr7", arrName: "arr" },
        { id: 8, name: "مشهد", arrange: "arrr8", arrName: "arr" },
    ];
    // useEffect(() => {
    ...
    return (
        <div ref={selectRef} className="relative z-30 w-full h-full mx-auto px-4 pb-4 pt-6">
            ...
            <div
                ...
                <ul className={`fixed top-[120px] left-[50%] translate-x-[-50%] pl-5 pr-7 sliderContainer w-[95%] h-[82%] pb-20 mt-2 bg-white overflow-x-hidden overflow-y-scroll`}>
                    {provinces.map((province, index) => (
                        ...
                        ${province.name.toLowerCase().includes(valueInput) ? "block  overflow-x-hidden" : "hidden"}
                        border-b-[#0000001A] border-b-[1px] flex justify-start items-center gap-x-2`}
                            onClick={() => {
                                if (province.name.toLowerCase() != valueInput) {
                                    setValueInput(province.name.toLowerCase());
                                }
                            }}

                        >
                            <label htmlFor={province.arrange}
                                onClick={() => {
                                    if (province.name.toLowerCase() != valueInput) {
                                        setValueInput(province.name.toLowerCase());
                                    }
                                ...
                                <input type="radio" name={province.arrName}  id={province.arrange} className="" />
                                {province.name}
                            </label>
                        </label>
                    ))}
