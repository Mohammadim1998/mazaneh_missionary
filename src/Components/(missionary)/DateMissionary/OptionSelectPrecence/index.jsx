    ...
    return (
        <div ref={selectRef} className="relative z-30 w-full h-full mx-auto">
            <div
                ...
                className="z-30 w-full h-[40px] px-4 py-[10px] border-[#E1E2E6] border-[1px] bg-white gap-x-2 rounded-lg flex items-center justify-between">
                <input
                    type="text"
                    readOnly
...
export default OptionSelectPrecence;
