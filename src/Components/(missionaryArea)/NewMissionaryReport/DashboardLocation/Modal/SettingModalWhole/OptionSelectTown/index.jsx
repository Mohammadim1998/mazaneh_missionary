...
const OptionSelectTown = ({ setTownInput, setOpenTownModal }) => {
    ...
    const towns = [
        { id: 1, name: "قم", arrange: "arrrr1", arrName: "arr" },
        { id: 2, name: "تهران", arrange: "arrrr2", arrName: "arr" },
        { id: 3, name: "اصفهان", arrange: "arrrr3", arrName: "arr" },
        { id: 4, name: "شیراز", arrange: "arrrr4", arrName: "arr" },
        { id: 5, name: "بندرعباس", arrange: "arrrr5", arrName: "arr" },
        { id: 6, name: "تبریز", arrange: "arrrr6", arrName: "arr" },
        { id: 7, name: "کیش", arrange: "arrrr7", arrName: "arr" },
        { id: 8, name: "مشهد", arrange: "arrrr8", arrName: "arr" },
    ];
