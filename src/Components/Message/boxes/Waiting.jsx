...
const Waiting = () => {
    ...
    return (
        <div className="relative w-full h-[249px] py-6 px-4 bg-white">
            ...
            <div className="w-full h-[29px] bg-[#9C840714] mb-[10px] rounded font-normal text-xs leading-5 text-[#816D08] flex justify-center items-center">درحال بررسی</div>

            <div className="w-full flex justify-between items-center">
                <div className="flex items-center">
                    <div className="text-[#828282CC] font-medium text-[10px] leading-5">زمان آخرین پیام:</div>
