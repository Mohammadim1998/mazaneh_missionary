...
const Answer = () => {
    ...
    return (
        <div className="w-full h-[249px] py-6 px-4 bg-white">
            ...
            <div className="w-full h-[29px] bg-[#2C8C0314] mb-[10px] rounded font-normal text-xs leading-5 text-[#2C8C03] gap-x-[6px] flex justify-center items-center">
                <div className="w-[19px] h-[19px] bg-[#2C8C03] rounded-full text-white font-bold text-xs leading-3 flex justify-center items-center">۲</div>
                پاسخ جدید
            </div>
