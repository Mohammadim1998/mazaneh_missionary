...
const BookMissionary = () => {
    const [swiperRef, setSwiperRef] = useState(null);

    return (
        <div className="relative w-full flex flex-col gap-y-5 bg-[#F0F0F1]">
            ...
            <div className="w-full bg-white px-4 pt-6 pb-12">
